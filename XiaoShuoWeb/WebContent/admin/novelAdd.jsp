  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="no_name" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" id="no_icon" name="img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
      ...
      <if condition="$iscid eq 1">
        <div class="form-group">
          ...
          <div class="field">
            <select name="no_class" class="input w50">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="no_introduction" style=" height:90px;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
     ...
     <!--  <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="no_author" value=""  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
